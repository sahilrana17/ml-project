...
class DataTransformation:
    ...
    def inititate_data_transformation(self, train_path, test_path):
        try:
            ...
            targate_columns_name = "Time_taken (min)"

            X_train = train_df.drop(columns=targate_columns_name, axis=1)
            y_train = train_df[targate_columns_name]

            X_test = test_df.drop(columns=targate_columns_name, axis=1)
            y_test = test_df[targate_columns_name]
